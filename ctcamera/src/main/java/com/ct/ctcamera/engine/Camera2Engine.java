package com.ct.ctcamera.engine;
...
import com.ct.ctcamera.CameraException;
import com.ct.ctcamera.CameraOptions;
...
import com.ct.ctcamera.engine.action.Action;
...
import com.ct.ctcamera.engine.action.CompletionCallback;
import com.ct.ctcamera.engine.action.LogAction;
import com.ct.ctcamera.engine.mappers.Camera2Mapper;
import com.ct.ctcamera.engine.meter.MeterAction;
import com.ct.ctcamera.engine.meter.MeterResetAction;
import com.ct.ctcamera.engine.offset.Axis;
import com.ct.ctcamera.engine.offset.Reference;
import com.ct.ctcamera.engine.options.Camera2Options;
import com.ct.ctcamera.engine.orchestrator.CameraState;
import com.ct.ctcamera.frame.Frame;
import com.ct.ctcamera.frame.FrameManager;
import com.ct.ctcamera.frame.ImageFrameManager;
import com.ct.ctcamera.gesture.Gesture;
import com.ct.ctcamera.internal.CropHelper;
import com.ct.ctcamera.internal.FpsRangeValidator;
import com.ct.ctcamera.metering.MeteringRegions;
import com.ct.ctcamera.picture.Full2PictureRecorder;
import com.ct.ctcamera.picture.Snapshot2PictureRecorder;
import com.ct.ctcamera.preview.RendererCameraPreview;
import com.ct.ctcamera.size.AspectRatio;
import com.ct.ctcamera.size.Size;
import com.ct.ctcamera.video.Full2VideoRecorder;
import com.ct.ctcamera.video.SnapshotVideoRecorder;
...
public class Camera2Engine extends CameraBaseEngine implements
        ...
        mFlashTask = getOrchestrator().scheduleStateful("flash (" + flash + ")",
            ...
            public void run() {
                ...
                if (needsWorkaround) {
                    ...
                    //mFlash = Flash.OFF;
                    //applyFlash(mRepeatingRequestBuilder, mFlash);
                    try {
                    ...
                    mFlash = flash;
                    updateFlash(flash.toString().toLowerCase());
                    //applyFlash(mRepeatingRequestBuilder, mFlash);
                    applyRepeatingRequestBuilder();
    ...
    void updateFlash(String mFlash) {
        switch (mFlash) {
            case Camera.Parameters.FLASH_MODE_OFF:
                mRepeatingRequestBuilder.set(CaptureRequest.CONTROL_AE_MODE,
                        CaptureRequest.CONTROL_AE_MODE_ON);
                mRepeatingRequestBuilder.set(CaptureRequest.FLASH_MODE,
